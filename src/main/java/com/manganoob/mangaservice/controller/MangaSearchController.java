...
import com.manganoob.mangaservice.service.SearchMangaService;
...
//    public ApiResponse<List<MangaResponse>> getMangasSortedByRating() {
//        List<MangaResponse> mangaResponses = searchMangaService.getMangasSortedByRating();
//        return ApiResponse.<List<MangaResponse>>builder()
//                .result(mangaResponses)
//                .build();
//    }
